                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('phoneverification.verify') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="code" type="number" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code') }}" required autocomplete="code" autofocus maxlength="4" maxlength="4">
